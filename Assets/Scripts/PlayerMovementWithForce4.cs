...
public class PlayerMovementWithForce4 : MonoBehaviour
{
    ...
    private void MoveArrows()
    {
        ...
        float moveHorizontal = Input.GetAxis("FourthHoriz"); // A и D
        float moveVertical = Input.GetAxis("FourthVert"); // W и S
